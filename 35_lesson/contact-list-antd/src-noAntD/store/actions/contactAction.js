...
export const ACTION_CONTACT_CLEAR_EDIT = 'ACTION_CONTACT_CLEAR_EDIT'
...
export function clearEdit () {
  return { type: ACTION_CONTACT_CLEAR_EDIT }
}
...
export function getServerOneContact (id) {
  return (dispatch) => {
    ContactAPI.getOneContact(id)
      .then((newContact) => {
